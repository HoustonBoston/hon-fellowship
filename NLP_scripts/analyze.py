...
if __name__ == "__main__":
    ...
    parser.add_argument("--question", "-q", type=str, required=False, help="The question to ask Ollama.",
                        default="""What are the tactics used within this scam? (grooming, impersonation, 
               investment, romance, social engineering)? Answer with only one term from the given list. If multiple,
               still choose the best fitting term.""")
